...
def filter_string(line: str) -> int:
...
def filter_string2b(line:str) -> int:
    digit_map = {"one": "on1ne",
                 "two": "tw2wo",
                  "three": "th3ee", "four":"fo4ur",
                 "five":"fi5ve",
                 "six":"si6",
                 "seven":"se7en",
                 "eight":"ei8ght",
...
def main():
    ...
    filtered_data = [filter_string(line) for line in data]
    result1a = sum(filtered_data)
    print(result1a)

    filtered_data2 = [filter_string2b(line) for line in data]
